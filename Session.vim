...
silent! normal! zE
let &fdl = &fdl
let s:l = 181 - ((0 * winheight(0) + 29) / 58)
...
set winwidth=1
argglobal
if bufexists("~/src/5p/lib/highlight.lua") | buffer ~/src/5p/lib/highlight.lua | else | edit ~/src/5p/lib/highlight.lua | endif
balt ~/src/5p/lib/highlight.lua
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
