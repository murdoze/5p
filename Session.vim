...
argglobal
1argu
if bufexists("lib/highlight.lua") | buffer lib/highlight.lua | else | edit lib/highlight.lua | endif
balt project.lua
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 133 - ((20 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 133
...
set winwidth=1
argglobal
if bufexists("~/src/5p/display.lua") | buffer ~/src/5p/display.lua | else | edit ~/src/5p/display.lua | endif
balt ~/src/5p/display.lua
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
set winwidth=1
argglobal
if bufexists("~/src/5p/data.lua") | buffer ~/src/5p/data.lua | else | edit ~/src/5p/data.lua | endif
balt ~/src/5p/data.lua
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
set winwidth=1
argglobal
if bufexists("~/src/5p/serdes.lua") | buffer ~/src/5p/serdes.lua | else | edit ~/src/5p/serdes.lua | endif
balt ~/src/5p/serdes.lua
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 59 - ((46 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 59
...
badd +1 ~/src/5p/lib/highlight.lua
badd +1 ~/src/5p/display.lua
badd +1 ~/src/5p/data.lua
badd +5 ~/src/5p/.exrc
badd +57 ~/src/5p/lib/serpent.lua
badd +1 ~/src/5p
badd +1 ~/src/5p/lib
badd +0 ~/src/5p/serdes.lua
